...
import CitizenDocumentProofModal from "./CitizenDocumentProofModal"; // Import the new modal component
import "../verifier/ApplicationDetails.css"; // Import CSS for modal (if you create a separate file)

const CitizenApplicationDetails = () => {
  ...
  useEffect(() => {
    ...
    const fetchApplicationDetails = async () => {
      console.log("Entered inside fetchApplicationDetails");
      try {
        console.log("Tring stated for fetching application details");
        setLoading(true);
        setError("");
        // Fetch application details using the ID
        const data = await authenticatedFetch(
          `/documents/application-details/${id}`,
          {
            method: "GET",
          }
        );
...
export default CitizenApplicationDetails;
